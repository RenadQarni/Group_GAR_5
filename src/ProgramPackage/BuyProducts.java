...
public class BuyProducts extends javax.swing.JFrame {
    ...
    public BuyProducts() {
        ...
        initComponents();
        products_list[0] = new Product("Auto food Dispenser", 100, false, 1);
        products_list[1] = new Product("Auto Pet Water", 100, false, 1);
        products_list[2] = new Product("Super Soft Bed", 150, false, 1);
        products_list[3] = new Product("Smart Pet Coller", 250, false, 1);
